...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'cpr_orchard_gazebo' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/sanskruti/catkin_ws/src/cpr_gazebo/cpr_orchard_gazebo/${idir}'.  ${_report}")
    endif()
